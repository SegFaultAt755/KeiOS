...
static void remap_pic(void) {
    ...
    static const struct pic seq[] = {{0x20, 0x11}, {0xA0, 0x11}, {0x21, 0x20}, {0xA1, 0x28}, {0x21, 0x04},
...
static void setup_irq(void) {
    static const void *handlers[] = {irq0, irq1, irq2,  irq3,  irq4,  irq5,  irq6,  irq7,
...
static void setup_idt() {
    static const void *handlers[] = {isr0,  isr1,  isr2,  isr3,  isr4,  isr5,  isr6,  isr7,  isr8,  isr9,  isr10,
