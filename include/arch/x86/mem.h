...
#define PTE_FRAME    0xFFFF'F000U /* Page frame address, mask for physical 4KB page address */
...
#define PDE_FRAME    0xFFFF'F000U /* Page frame address, mask for physical page table address */
